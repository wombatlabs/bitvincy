...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s bitvincy-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  bitvincy-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bitvincy transaction") + "\n" +
              "  bitvincy-tx [options] -create [commands]   " + _("Create hex-encoded bitvincy transaction") + "\n" +
              "\n";
