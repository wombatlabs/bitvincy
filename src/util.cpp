...
const char * const BITCOIN_CONF_FILENAME = "bitvincy.conf";
const char * const BITCOIN_PID_FILENAME = "bitvincy.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "bitvincy";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/bitvincy";
#else
    // Unix
    return pathRet / ".bitvincy";
#endif
#endif
}
