...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/bitvincy-project/bitvincy>";
    const std::string URL_WEBSITE = "<https://bitvincy.org>";
